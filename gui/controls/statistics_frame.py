...
class StatisticsFrame:
    ...
    def __init__(self, parent):
        ...
        ttk.Label(metrics_frame, text="Поколение:").grid(row=0, column=0, sticky="w", padx=5, pady=2)
        self.generation_label = ttk.Label(metrics_frame, text="-")
        self.generation_label.grid(row=0, column=1, sticky="w", padx=5)
        
        ttk.Label(metrics_frame, text="Лучшее значение:").grid(row=1, column=0, sticky="w", padx=5, pady=2)
        self.best_label = ttk.Label(metrics_frame, text="-")
        self.best_label.grid(row=1, column=1, sticky="w", padx=5)
        
        ttk.Label(metrics_frame, text="Среднее значение:").grid(row=2, column=0, sticky="w", padx=5, pady=2)
        self.avg_label = ttk.Label(metrics_frame, text="-")
        self.avg_label.grid(row=2, column=1, sticky="w", padx=5)
        
        ttk.Label(metrics_frame, text="Худшее значение:").grid(row=3, column=0, sticky="w", padx=5, pady=2)
        self.worst_label = ttk.Label(metrics_frame, text="-")
        self.worst_label.grid(row=3, column=1, sticky="w", padx=5)
        
        ttk.Label(metrics_frame, text="Вес МОД:").grid(row=4, column=0, sticky="w", padx=5, pady=2)
