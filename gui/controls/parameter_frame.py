...
class ParameterFrame:
    ...
    def __init__(self, parent):
        ...
        # Размер популяции
        ttk.Label(self.frame, text="Размер популяции").grid(row=0, column=0, sticky="w", padx=5, pady=3)
        self.population = ttk.Entry(self.frame, width=12)
        self.population.insert(0, "100")
        self.population.grid(row=0, column=1)
        
        # Количество поколений
        ttk.Label(self.frame, text="Количество поколений").grid(row=1, column=0, sticky="w", padx=5, pady=3)
        self.generations = ttk.Entry(self.frame, width=12)
        self.generations.insert(0, "200")
        self.generations.grid(row=1, column=1)
        
        # Вероятность скрещивания
        ttk.Label(self.frame, text="Вероятность скрещивания").grid(row=2, column=0, sticky="w", padx=5, pady=3)
        self.crossover = ttk.Entry(self.frame, width=12)
        self.crossover.insert(0, "0.8")
        self.crossover.grid(row=2, column=1)
        
        # Вероятность мутации
        ttk.Label(self.frame, text="Вероятность мутации").grid(row=3, column=0, sticky="w", padx=5, pady=3)
        self.mutation = ttk.Entry(self.frame, width=12)
        self.mutation.insert(0, "0.05")
        self.mutation.grid(row=3, column=1)
        
        # Метод селекции
        ttk.Label(self.frame, text="Метод селекции").grid(row=4, column=0, sticky="w", padx=5, pady=3)
        ...
        # Размер турнира
        ttk.Label(self.frame, text="Размер турнира").grid(row=5, column=0, sticky="w", padx=5, pady=3)
        ...
        # Метод скрещивания
        ttk.Label(self.frame, text="Метод скрещивания").grid(row=6, column=0, sticky="w", padx=5, pady=3)
        self.crossover_method = ttk.Combobox(
            self.frame,
            values=[CrossoverType.ONE_POINT.value, CrossoverType.TWO_POINT.value, CrossoverType.UNIFORM.value],
            state="readonly",
            width=18
        )
        ...
        # Метод мутации
        ttk.Label(self.frame, text="Метод мутации").grid(row=7, column=0, sticky="w", padx=5, pady=3)
        ...
        # Элитизм
        ttk.Label(self.frame, text="Элитизм").grid(row=8, column=0, sticky="w", padx=5, pady=3)
