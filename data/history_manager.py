...
class HistoryManager:
    ...
    def add_steps(self, step: GAStateStep):
        ...
        if self._cur_index < len(self._history) - 1:
            ...
            self._history.best_fitness_history = self._history.best_fitness_history[
                : self._cur_index + 1
            ]
            self._history.avg_fitness_history = self._history.avg_fitness_history[
                : self._cur_index + 1
            ]
            self._history.worst_fitness_history = self._history.worst_fitness_history[
                : self._cur_index + 1
            ]
